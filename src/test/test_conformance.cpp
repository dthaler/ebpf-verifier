...
TEST_CONFORMANCE_FAIL("be32-high.data")
...
TEST_CONFORMANCE_FAIL("jeq-imm.data")
TEST_CONFORMANCE_FAIL("jeq-reg.data")
TEST_CONFORMANCE_FAIL("jge-imm.data")
TEST_CONFORMANCE_FAIL("jgt-imm.data")
TEST_CONFORMANCE_FAIL("jgt-reg.data")
TEST_CONFORMANCE("jit-bounce.data")
TEST_CONFORMANCE_FAIL("jle-imm.data")
TEST_CONFORMANCE_FAIL("jle-reg.data")
TEST_CONFORMANCE_FAIL("jlt-imm.data")
TEST_CONFORMANCE_FAIL("jlt-reg.data")
TEST_CONFORMANCE_FAIL("jne-reg.data")
TEST_CONFORMANCE_FAIL("jset-imm.data")
TEST_CONFORMANCE_FAIL("jset-reg.data")
TEST_CONFORMANCE_FAIL("jsge-imm.data")
TEST_CONFORMANCE_FAIL("jsge-reg.data")
TEST_CONFORMANCE_FAIL("jsgt-imm.data")
TEST_CONFORMANCE_FAIL("jsgt-reg.data")
TEST_CONFORMANCE_FAIL("jsle-imm.data")
TEST_CONFORMANCE_FAIL("jsle-reg.data")
TEST_CONFORMANCE_FAIL("jslt-imm.data")
TEST_CONFORMANCE_FAIL("jslt-reg.data")
